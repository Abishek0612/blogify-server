...
exports.getPosts = asyncHandler(async (req, res) => {
  ...
  //! get the category and searchterm from request ( for filtering by category)
  const category = req.query.category;
  const searchTerm = req.query.searchTerm;

  //query (we are going to change const to let coz we are going to modify it)
  let query = {
  ...
  const page = parseInt(req.query.page, 10) || 1; //if the user doesn't provide any page number then default will be 1
